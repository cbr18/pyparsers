...
def _build_blocked_payload(source: str, blocked: int, checks: Dict[str, int], details: Dict[str, Any]):
    return {
        "data": {
            "source": source,
            "blocked": blocked,
